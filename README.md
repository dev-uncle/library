...
2. Goto Both 'Frontend' and 'Backend' different terminal
...
````change the URL, EMAIL and Password using google app
...
`make sure your MondoDB and mongodb compass server is running (you can check this via windows Services)`
